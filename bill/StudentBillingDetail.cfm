...
<cfset varTerm = #Session.selectedTerm#>
...
<nav class="top-bar">
	<ul class="menu">
		<li><a href="SetUpBilling.cfm">Generate Billing</a></li>
		<li><a href="Billing.cfm">Billing Summary</a></li>
		<li><a href="StudentBilling.cfm">Student List</a></li>
 	</ul>
</nav>
